...
public class ShopServiceImpl implements ShopService {
    ...
    public Optional<ShopDto> getShopById(Long id) {
        return shopRepository.findById(id)
                .map(shop -> {
                    ...
                    shopDto.setShopOwnerId(shop.getShopOwner().getId());
                    return shopDto;
                });
    }
    ...
    public Optional<ShopDto> getShopByUserId(Long userId) {
        return shopRepository.findByShopOwnerId(userId).stream()
                .findFirst()
                .map(shop -> {
                    ShopDto shopDto = modelMapper.map(shop, ShopDto.class);
                    shopDto.setShopOwnerId(shop.getShopOwner().getId());
    ...
    public ShopDto updateShop(Long id, ShopDto shopDto) {
        ...
        result.setShopOwnerId(updatedShop.getShopOwner().getId());
        return result;
    }
